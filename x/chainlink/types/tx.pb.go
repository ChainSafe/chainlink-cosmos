...
type MsgFeedData struct {
	...
	// which means each report is a byte array which could be deserialized to OffChainReport type
...
type OCRFeedDataInStore struct {
	...
	Report   *OffChainReport `protobuf:"bytes,3,opt,name=report,proto3" json:"report,omitempty"`
}
...
func (m *OCRFeedDataInStore) GetReport() *OffChainReport {
	if m != nil {
		return m.Report
	}
	return nil
...
func (m *Observation) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *AttributedObservation) Reset()         { *m = AttributedObservation{} }
func (m *AttributedObservation) String() string { return proto.CompactTextString(m) }
...
func (m *AttributedObservation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AttributedObservation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AttributedObservation.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AttributedObservation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AttributedObservation.Merge(m, src)
}
func (m *AttributedObservation) XXX_Size() int {
	return m.Size()
}
func (m *AttributedObservation) XXX_DiscardUnknown() {
	xxx_messageInfo_AttributedObservation.DiscardUnknown(m)
}

var xxx_messageInfo_AttributedObservation proto.InternalMessageInfo

func (m *AttributedObservation) GetObservation() *Observation {
	if m != nil {
...
func (m *AttributedObservation) GetObserver() uint32 {
	if m != nil {
		return m.Observer
	}
	return 0
...
func (m *AttestedReportMany) Reset()         { *m = AttestedReportMany{} }
func (m *AttestedReportMany) String() string { return proto.CompactTextString(m) }
func (*AttestedReportMany) ProtoMessage()    {}
func (*AttestedReportMany) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e2cf97733d10959, []int{20}
}
func (m *AttestedReportMany) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AttestedReportMany) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AttestedReportMany.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AttestedReportMany) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AttestedReportMany.Merge(m, src)
}
func (m *AttestedReportMany) XXX_Size() int {
	return m.Size()
}
func (m *AttestedReportMany) XXX_DiscardUnknown() {
	xxx_messageInfo_AttestedReportMany.DiscardUnknown(m)
}

var xxx_messageInfo_AttestedReportMany proto.InternalMessageInfo

func (m *AttestedReportMany) GetAttributedObservations() []*AttributedObservation {
	if m != nil {
		return m.AttributedObservations
	}
	return nil
}

func (m *AttestedReportMany) GetSignatures() [][]byte {
	if m != nil {
		return m.Signatures
	}
	return nil
...
func (m *ConfigDigest) Reset()         { *m = ConfigDigest{} }
func (m *ConfigDigest) String() string { return proto.CompactTextString(m) }
func (*ConfigDigest) ProtoMessage()    {}
func (*ConfigDigest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e2cf97733d10959, []int{21}
}
func (m *ConfigDigest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConfigDigest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfigDigest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfigDigest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfigDigest.Merge(m, src)
}
func (m *ConfigDigest) XXX_Size() int {
	return m.Size()
}
func (m *ConfigDigest) XXX_DiscardUnknown() {
	xxx_messageInfo_ConfigDigest.DiscardUnknown(m)
}

var xxx_messageInfo_ConfigDigest proto.InternalMessageInfo

func (m *ConfigDigest) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
type ReportContext struct {
	ConfigDigest *ConfigDigest `protobuf:"bytes,1,opt,name=configDigest,proto3" json:"configDigest,omitempty"`
	Epoch        uint32        `protobuf:"varint,2,opt,name=epoch,proto3" json:"epoch,omitempty"`
	Round        uint8         `protobuf:"varint,3,opt,name=round,proto3,casttype=uint8" json:"round,omitempty"`
}

func (m *ReportContext) Reset()         { *m = ReportContext{} }
func (m *ReportContext) String() string { return proto.CompactTextString(m) }
func (*ReportContext) ProtoMessage()    {}
func (*ReportContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e2cf97733d10959, []int{22}
}
func (m *ReportContext) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReportContext) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReportContext.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReportContext) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReportContext.Merge(m, src)
}
func (m *ReportContext) XXX_Size() int {
	return m.Size()
}
func (m *ReportContext) XXX_DiscardUnknown() {
	xxx_messageInfo_ReportContext.DiscardUnknown(m)
}

var xxx_messageInfo_ReportContext proto.InternalMessageInfo

func (m *ReportContext) GetConfigDigest() *ConfigDigest {
	if m != nil {
...
func (m *ReportContext) GetEpoch() uint32 {
	if m != nil {
		return m.Epoch
	}
	return 0
...
func (m *ReportContext) GetRound() uint8 {
	if m != nil {
		return m.Round
	}
	return 0
...
// OffChainReport corresponds to the "final" message. It is sent by the
// current leader with the aggregated signature(s) of all participating oracles
type OffChainReport struct {
	Context *ReportContext      `protobuf:"bytes,1,opt,name=context,proto3" json:"context,omitempty"`
	Report  *AttestedReportMany `protobuf:"bytes,2,opt,name=report,proto3" json:"report,omitempty"`
}

func (m *OffChainReport) Reset()         { *m = OffChainReport{} }
func (m *OffChainReport) String() string { return proto.CompactTextString(m) }
func (*OffChainReport) ProtoMessage()    {}
func (*OffChainReport) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e2cf97733d10959, []int{23}
}
func (m *OffChainReport) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OffChainReport) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OffChainReport.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OffChainReport) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OffChainReport.Merge(m, src)
}
func (m *OffChainReport) XXX_Size() int {
	return m.Size()
}
func (m *OffChainReport) XXX_DiscardUnknown() {
	xxx_messageInfo_OffChainReport.DiscardUnknown(m)
}

var xxx_messageInfo_OffChainReport proto.InternalMessageInfo

func (m *OffChainReport) GetContext() *ReportContext {
	if m != nil {
		return m.Context
	}
	return nil
...
func (m *OffChainReport) GetReport() *AttestedReportMany {
	if m != nil {
		return m.Report
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AttributedObservation)(nil), "chainlink.v1beta.AttributedObservation")
	proto.RegisterType((*AttestedReportMany)(nil), "chainlink.v1beta.AttestedReportMany")
	proto.RegisterType((*ConfigDigest)(nil), "chainlink.v1beta.ConfigDigest")
	proto.RegisterType((*ReportContext)(nil), "chainlink.v1beta.ReportContext")
	proto.RegisterType((*OffChainReport)(nil), "chainlink.v1beta.OffChainReport")
}
...
var fileDescriptor_8e2cf97733d10959 = []byte{
	...
	,
}
...
func (m *AttributedObservation) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AttributedObservation) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AttributedObservation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Observer != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.Observer))
		i--
		dAtA[i] = 0x10
	}
...
func (m *AttestedReportMany) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AttestedReportMany) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AttestedReportMany) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.AttributedObservations) > 0 {
		for iNdEx := len(m.AttributedObservations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AttributedObservations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ConfigDigest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfigDigest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConfigDigest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReportContext) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReportContext) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReportContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ConfigDigest != nil {
		{
			size, err := m.ConfigDigest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *OffChainReport) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OffChainReport) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OffChainReport) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AttributedObservation) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Observer != 0 {
		n += 1 + sovTx(uint64(m.Observer))
	}
	return n
}

func (m *AttestedReportMany) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.AttributedObservations) > 0 {
		for _, e := range m.AttributedObservations {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *ConfigDigest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReportContext) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OffChainReport) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AttributedObservation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AttributedObservation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AttributedObservation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Observer |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AttestedReportMany) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AttestedReportMany: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AttestedReportMany: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AttributedObservations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AttributedObservations = append(m.AttributedObservations, &AttributedObservation{})
			if err := m.AttributedObservations[len(m.AttributedObservations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *ConfigDigest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfigDigest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfigDigest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ReportContext) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReportContext: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReportContext: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if err := m.ConfigDigest.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *OffChainReport) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OffChainReport: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OffChainReport: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
