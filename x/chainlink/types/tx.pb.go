...
type MsgFeed struct {
	...
	// LastUpdate is the time of which the last feedData was submitted.
	LastUpdate *time.Time `protobuf:"bytes,9,opt,name=lastUpdate,proto3,stdtime" json:"lastUpdate,omitempty"`
}
...
func (m *MsgFeed) GetLastUpdate() *time.Time {
	if m != nil {
		return m.LastUpdate
	}
	return nil
...
var fileDescriptor_8e2cf97733d10959 = []byte{
	...
	,
}
