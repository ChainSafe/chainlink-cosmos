...
addFeedTx=$($chainlinkCMD addFeed feedid1 "this is test feed description" $aliceAddr 1 2 3 100 "" $aliceAddr,$alicePK --from alice --keyring-backend test --chain-id testchain <<< 'y\n')
